 ...
 * Time: 4:03 PM
 */
public class MakeItImmutableClassAdapter extends ClassAdapter {
    private ClassVisitor wrappedVisitor;

    public MakeItImmutableClassAdapter(ClassVisitor wrappedVisitor) {
    ...
    public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        ...
        return new MethodEndLoggingMethodVisitor(methodVisitor);
    }
}
